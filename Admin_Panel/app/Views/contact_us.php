...
<html lang="en">
    <head>
        <title>Contact Us | <?= ($app_name) ? $app_name[0]->message : '' ?></title>        
                            ...
                            <div class="col-md-12">
                                <div class="card card-secondary">
                                    <div class="card-header">
                                        <h3 class="card-title">Contact Us <small> Policy for App Usage</small></h3>
                                        <div class="float-right">
                                            <a href="<?php echo base_url(); ?>/play_store_contact_us" target='_blank' rel="noopener noreferrer" class='btn btn-primary'>Contact Us Page for Play Store</a>
                                        </div>
                                    </div>
                                    <form action="<?= base_url(); ?>/store_contact_us" role="form" id="insert_form" method="POST" enctype="multipart/form-data">
                                        <?= csrf_field() ?>
                                        <div class="card-body"> 
                                            <div class="form-group row">                                                
                                                <label class="col-sm-2 col-form-label">Contact Us</label>
                                                <div class="col-sm-10">
