...
<html lang="en">
    <head>
        <title>About Us | <?= ($app_name) ? $app_name[0]->message : '' ?></title>        
                            ...
                            <div class="col-md-12">
                                <div class="card card-secondary">
                                    <div class="card-header">
                                        <h3 class="card-title">About Us <small> Policy for App Usage</small></h3>
                                    ...
                                    <form action="<?= base_url(); ?>/store_about_us" role="form" id="insert_form" method="POST" enctype="multipart/form-data">
                                        <?= csrf_field() ?>
                                        <div class="card-body"> 
