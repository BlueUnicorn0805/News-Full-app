...
<html lang="en">
    <head>
        <title>Privacy Policy | <?= ($app_name) ? $app_name[0]->message : '' ?></title>        
                            ...
                            <div class="col-md-12">
                                <div class="card card-secondary">
                                    <div class="card-header">
                                        <h3 class="card-title">Privacy Policy <small> Policy for App Usage</small></h3>
                                    ...
                                    <form action="<?= base_url(); ?>/store_policy" role="form" id="insert_form" method="POST" enctype="multipart/form-data">
                                        <?= csrf_field() ?>
                                        <div class="card-body"> 
