		...
		<div class="container">
			...
			<p>
				...
				<a href="https://www.google.com/search?q=<?= urlencode($title . ' ' . preg_replace('#\'.*\'|".*"#Us', '', $exception->getMessage())) ?>"
				   rel="noopener noreferrer" target="_blank">search &rarr;</a>
			</p>
		</div>
	</div>
		...
		<div class="tab-content">
							...
							<?php if (isset($row['class'])) : ?>
								...
								<?php if (! empty($row['args'])) : ?>
									...
									<div class="args" id="<?= $args_id ?>">
										<table aria-describedby="mydesc" cellspacing="0">
										...
										foreach ($row['args'] as $key => $value) : ?>
											<tr>
												<th scope="col"><code><?= htmlspecialchars(isset($params[$key]) ? '$' . $params[$key]->name : "#$key", ENT_SUBSTITUTE, 'UTF-8') ?></code></th>
												<th scope="col"><pre><?= print_r($value, true) ?></pre></th>
											</tr>
										<?php endforeach ?>
			...
			<div class="content" id="request">
				...
				<table aria-describedby="mydesc">
					<tbody>
						<tr>
							<th scope="col" style="width: 10em">Path</th>
			...
			<div class="content" id="response">
				<table aria-describedby="mydesc">
					<tr>
						<th scope="col" style="width: 15em">Response Status</th>
						<th scope="col"><?= $response->getStatusCode() . ' - ' . $response->getReason() ?></th>
					</tr>
				</table>
				...
				<table aria-describedby="mydesc">
					<tbody>
						<tr>
							...
							<th scope="col"><?= static::describeMemory(memory_get_usage(true)) ?></th>
						</tr>
						<tr>
